...
exports.hasAzVulgar = hasAzVulgar;
exports.censorAzVulgar = censorAzVulgar;
const VULGAR_WORDS = [
...
function looseWordPattern(word) {
...
const WORD_REGEXES = VULGAR_WORDS.map((w) => {
...
function censorAzVulgar(text) {
    let t = String(text || "");
    for (const r of WORD_REGEXES) {
        r.lastIndex = 0;
        t = t.replace(r, (_m, p1, p2) => {
